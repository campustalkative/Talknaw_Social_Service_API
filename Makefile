...
format : 
	$(AUTOFLAKE) --in-place --remove-unused-variables --recursive ./sms ./test
	$(BLACK) --preview ./sms ./test
.PHONY : format
...
unit-test : 
	pytest --cov=sms test/unit
.PHONY : unit-test

integration-test : 
	pytest --cov=sms test/integration
